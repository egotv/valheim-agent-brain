...
#     input_object = InputObject("What is the meaning of life?", "The player is in a forest.", PlayerMemory())

#     thinker = ClaudeThinker()
#     output_object = thinker.think(input_object)
