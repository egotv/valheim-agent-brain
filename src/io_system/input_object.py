...
class InputObject:
    ...
    def __init__(self, player_instruction: str, game_state: GameState, player_memory: PlayerMemory, personality: str, retrieved_knowledge: str="", agent_commands: List[AgentCommand]=None):
